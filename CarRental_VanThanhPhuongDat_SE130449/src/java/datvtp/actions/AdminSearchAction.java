...
public class AdminSearchAction extends ActionSupport {
    ...
    public void validate() {
        try {
            ...
            logger.error("ERROR at UserSearchAction: " + e.getMessage());
        }
    }
    ...
    public String execute() {
        try {
            ...
            int numberRecord = 20;
            int totalRecord = carDAO.getNumberOfCarForAdmin(name, category, rentalDate, returnDate, Integer.parseInt(amount));
            ...
            list = carDAO.getListCarForAdmin(name, category, rentalDate, returnDate, Integer.parseInt(amount), offsetRecord, numberRecord); //
            ...
            logger.error("ERROR NumberFormat at UserSearchAction: " + e.getMessage());
        } catch (SQLException e) {
            logger.error("ERROR SQL at UserSearchAction: " + e.getMessage());
        } catch (NamingException e) {
            logger.error("ERROR Naming at UserSearchAction: " + e.getMessage());
        }
        return "success";
    }
